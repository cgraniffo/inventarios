...
|---|---|---|---|
| `magic-link.html` | Magic Link | `{{ .SiteURL }}/auth/confirm?token_hash={{ .TokenHash }}&type=email` (flujo token-hash, robusto en celular; base fija al dominio de producción) | Tu enlace de acceso a Empresa Demo |
